...
import 'package:admin/Food/DoctorsBottomSheetWidget.dart';
import 'package:admin/Food/LocationssBottomSheetWidget.dart';
import 'package:admin/Food/ViewsModel.dart';
import 'package:admin/Update/userDetails.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        ...
        } else if (food.Special == 'Extra' || food.Special == 'Appatizer') {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => UserDetails(
        ...
        child: Row(
          children: [
            ...
            IconButton(
              ...
              onPressed: () async {
                // إخفاء الـ Focus من الحقل الحالي (لضمان أنه لا يبقى في حالة التركيز عند الحذف)
                FocusScope.of(context).unfocus();

                // تأكيد الحذف باستخدام Dialog إذا أردت التأكيد قبل الحذف
                    ...
                    return AlertDialog(
                      ...
                      actions: [
                        TextButton(
                          child: Text('Cancel'),
                          onPressed: () {
                            Navigator.of(context).pop(false); // لا يتم الحذف
                          },
                        ),
                        TextButton(
                          child: Text('Delete'),
                ...
                if (confirmDelete) {
                  try {
                    ...
                    await FirebaseFirestore.instance
                        .collection('Foods')
                        .doc(food
                            .id) // استخدم الـ id الخاص بالغذاء الذي تريد حذفه
                        .delete();
                    // تأكيد الحذف

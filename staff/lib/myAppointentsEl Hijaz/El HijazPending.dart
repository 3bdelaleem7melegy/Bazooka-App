...
class ElHijazPending extends StatefulWidget {
  const ElHijazPending({super.key});

  @override
  _ElHarmPendingState createState() => _ElHarmPendingState();
}

class _ElHarmPendingState extends State<ElHijazPending> {
    ...
    return SafeArea(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('Location',isEqualTo: 'El Hijaz')
            .where('date', isEqualTo: date)
            // .where('date',isEqualTo: date)
            .snapshots(),

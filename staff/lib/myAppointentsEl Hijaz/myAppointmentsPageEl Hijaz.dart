...
class MyAppointmentsElHijaz extends StatefulWidget {
  const MyAppointmentsElHijaz({super.key});

  @override
  _MyAppointmentsElHaramState createState() => _MyAppointmentsElHaramState();
}

class _MyAppointmentsElHaramState extends State<MyAppointmentsElHijaz> {

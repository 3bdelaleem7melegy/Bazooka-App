...
class ElMokatampending extends StatefulWidget {
  const ElMokatampending({super.key});

  @override
  _NasrcitypendingState createState() => _NasrcitypendingState();
}

class _NasrcitypendingState extends State<ElMokatampending> {
    ...
    return SafeArea(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('Location', isEqualTo: 'El Mokatam')
            .where('date', isEqualTo: date)
            // .where('date',isEqualTo: date)
            .snapshots(),

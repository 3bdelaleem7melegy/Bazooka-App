...
class ElShiekhZayedpending extends StatefulWidget {
  const ElShiekhZayedpending({super.key});

  @override
  _NasrcitypendingState createState() => _NasrcitypendingState();
}

class _NasrcitypendingState extends State<ElShiekhZayedpending> {
    ...
    return SafeArea(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('Location',isEqualTo: 'El Shiekh Zayed')
            .where('date', isEqualTo: date)
            // .where('date',isEqualTo: date)
            .snapshots(),

...
class Faisalpending extends StatefulWidget {
  const Faisalpending({super.key});

  @override
  _NasrcitypendingState createState() => _NasrcitypendingState();
}

class _NasrcitypendingState extends State<Faisalpending> {
    ...
    return SafeArea(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('Location',isEqualTo: 'Faisal')
            .where('date', isEqualTo: date)
            // .where('date',isEqualTo: date)
            .snapshots(),

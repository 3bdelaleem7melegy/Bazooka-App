...
class FifthSettlementPending extends StatefulWidget {
  const FifthSettlementPending({super.key});

  @override
  _ElHarmPendingState createState() => _ElHarmPendingState();
}

class _ElHarmPendingState extends State<FifthSettlementPending> {
    ...
    return SafeArea(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('Location',isEqualTo: 'Fifth Settlement')
            .where('date', isEqualTo: date)
            // .where('date',isEqualTo: date)
            .snapshots(),

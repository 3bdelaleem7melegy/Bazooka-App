...
class Nasrcitypending extends StatefulWidget {
  const Nasrcitypending({super.key});

  @override
  _NasrcitypendingState createState() => _NasrcitypendingState();
}

class _NasrcitypendingState extends State<Nasrcitypending> {
    ...
    return SafeArea(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('Location',isEqualTo: 'Nasr City')
            .where('date', isEqualTo: date)
            // .where('date',isEqualTo: date)
            .snapshots(),

...
class BookingScreenExtra extends StatefulWidget {
  Food food;

  BookingScreenExtra({super.key, required this.food});

  @override
  _BookingScreenExtraState createState() => _BookingScreenExtraState();
}

class _BookingScreenExtraState extends State<BookingScreenExtra> {
  ...
  void initState() {
    ...
    // Set default price as the first item

...
class modelMeals extends StatelessWidget {
  @override
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: bannerSpecialMeals[index].cardBackground,
              ),
            ),
            child: GestureDetector(
              onTap: () {
                if (index >= bannerSpecialMeals.length - 1) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) =>
                          SpecailList(specailList: bannerSpecialMeals[index].text),
                    ),
                  );
                } else {
                  Navigator.push(
  ...
  children: [
    // الصورة
    Image.asset(
      bannerSpecialMeals[index].image,

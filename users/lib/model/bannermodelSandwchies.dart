...
import 'package:users/model/bannerModel.dart';
import 'package:users/food/Special_List.dart';


class modelSandwchies extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: CarouselSlider.builder(
        itemCount: bannerSpecialSandwiches.length,
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: bannerSpecialSandwiches[index].cardBackground,
              ),
            ),
            child: GestureDetector(
              onTap: () {
                if (index >= bannerSpecialSandwiches.length - 1) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) =>
                          SpecailList(specailList: bannerSpecialSandwiches[index].text),
                    ),
                  );
                } else {
                  Navigator.push(
  ...
  children: [
    // الصورة
    Image.asset(
      bannerSpecialSandwiches[index].image,
    ...
    Positioned(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(
              bannerSpecialSandwiches[index].text,
